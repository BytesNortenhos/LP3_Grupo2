...
//        boolean result = startSportsController.sportStart(sportAdd.getIdSport(), year,2);
//        assertTrue(result);
...
//            List<Registration> regs = RegistrationDao.getRegistrationById(athl.getIdAthlete());
...
//        //Verificar se a modalidade foi iniciada
//        StartSportsController startSportsController = new StartSportsController();
//        boolean result = startSportsController.iniciarModalidades(sportAdd.getIdSport(), year);
//        assertTrue(result);
//        System.out.println("Modalidade Iniciada");
//
//        //Verifica se os registos foram adicionados
...
//Existiu uma compatibilidade no merge nas DAOS, impossibilitando o funcionamento.